    ...
    <footer className="w-full bg-nexus-card border-t border-nexus-border pt-16 pb-32 sm:pb-8 mt-20 relative z-10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <h4 className="font-bold text-nexus-text mb-4">Legal</h4>
          ...
          <div className="space-y-4">
            <h4 className="font-bold text-nexus-text mb-4">Empresa</h4>
            <ul className="space-y-3">
              <li>
        ...
        <div className="pt-8 mb-8">
           <h4 className="font-bold text-nexus-text text-center mb-4">¿Necesitas ayuda?</h4>
