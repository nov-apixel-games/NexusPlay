...
export default function DeveloperConsole({ userId, userProfile, onClose, onAddApp, publishedApps: initialApps }: DeveloperConsoleProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex bg-[#030712] overflow-hidden animate-in fade-in duration-500">
      ...
      {/* SIDEBAR */}
      <aside className={`
        fixed inset-y-0 left-0 z-[120] w-80 border-r border-white/5 flex flex-col bg-black/90 backdrop-blur-xl transition-transform duration-300 lg:relative lg:translate-x-0 lg:bg-black/40
        ...
        <div className="p-8 pb-12 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[8px] font-black text-white/40 tracking-[0.3em] uppercase mt-1">SISTEMA MULTI-NODAL</p>
            </div>
          </div>
            ...
            return (
              <button
                ...
                className={`
                   ...
                   ${isActive ? 'bg-white text-black font-black' : 'text-gray-500 hover:text-white hover:bg-white/5'}
              ...
              >
                ...
                <Icon className={`w-5 h-5 ${isActive ? 'text-black' : item.highlight ? 'text-cyan-400' : 'text-gray-400 group-hover:text-white'}`} />
        ...
        <div className="p-6">
          <div className="bg-white/[0.03] rounded-3xl p-6 border border-white/5 space-y-4">
             <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-full overflow-hidden bg-white/10 ring-2 ring-cyan-500/30">
                   <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${userId}`} alt="Avatar" />
                </div>
                <div className="min-w-0">
                   <p className="text-xs font-black text-white truncate uppercase tracking-tight">{userProfile?.username || 'Desarrollador'}</p>
                   <p className="text-[8px] font-black text-cyan-400 uppercase tracking-widest">{userProfile?.role}</p>
                </div>
             </div>
             <button onClick={onClose} className="w-full flex items-center justify-center gap-2 py-3 bg-red-500/10 text-red-400 rounded-xl hover:bg-red-500 hover:text-white transition-all text-[10px] font-black uppercase tracking-widest">
           ...
           <>
              ...
              <div className="h-20 shrink-0 border-b border-white/5 flex items-center justify-between px-4 lg:px-12 bg-black/20">
                <div className="flex items-center gap-3 lg:gap-4">
                  ...
                  <h2 className="text-xl lg:text-2xl font-black text-white uppercase tracking-tighter truncate">
                ...
                <div className="flex items-center gap-4">
                   ...
                   <button onClick={() => setActiveTab('publish')} className="p-2.5 bg-white text-black hover:bg-cyan-500 rounded-xl transition-colors">
                  ...
                  >
                          ...
                          {[
                            ...
                            <div key={idx} className={`${stat.bg} p-6 lg:p-8 rounded-[2rem] lg:rounded-[2.5rem] border border-white/5 space-y-4 hover:border-white/10 transition-all hover:translate-y-[-4px]`}>
                               ...
                               <div>
                                 ...
                                 <p className="text-3xl lg:text-4xl font-black text-white tracking-tighter leading-none">{stat.value}</p>
                               </div>
                            </div>
                          ))}
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                           <div className="lg:col-span-2 space-y-6">
                              <div className="flex items-center justify-between">
                                 <h3 className="text-xl font-black text-white uppercase tracking-tighter">Últimos Lanzamientos</h3>
                              ...
                              <div className="grid grid-cols-1 gap-4">
                                {apps.slice(0, 3).map((app) => (
                                  <div key={app.id} className="p-4 lg:p-6 bg-white/[0.02] border border-white/5 rounded-3xl flex items-center gap-4 lg:gap-6 hover:bg-white/[0.04] transition-all">
                                     <img src={app.icon_url} className="w-12 h-12 lg:w-16 lg:h-16 rounded-2xl object-cover shrink-0" />
                                     <div className="flex-1 min-w-0">
                                        <h4 className="text-base lg:text-lg font-black text-white truncate uppercase tracking-tight">{app.app_name}</h4>
                                        <p className="text-[10px] lg:text-xs text-gray-500 flex items-center gap-2">
                                     ...
                                     <div className="text-right flex items-center gap-3 lg:gap-6 shrink-0">
                                        <div className="hidden sm:block">
                                           <p className="text-[10px] lg:text-xs font-black text-white whitespace-nowrap">{app.downloads} Descargas</p>
                                           <div className="flex items-center gap-1 text-yellow-500 mt-1 pointer-events-none">
                                              <Star className="w-3 h-3 fill-current" />
                                              <span className="text-[10px] font-black uppercase text-gray-400">{app.rating}</span>
                                           </div>
                                        </div>
                                        <button className="p-2 lg:p-3 bg-white/5 hover:bg-white text-white hover:text-black rounded-xl transition-all">
                                ...
                                {apps.length === 0 && (
                                  <div className="p-12 bg-white/[0.02] border border-dashed border-white/10 rounded-3xl text-center">
                                     ...
                                     <p className="text-gray-500 font-bold uppercase text-xs">No hay aplicaciones publicadas aún.</p>
                           ...
                           <div className="space-y-6">
                              <h3 className="text-xl font-black text-white uppercase tracking-tighter">Cuenta Developer</h3>
                              <div className="p-6 lg:p-8 bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-500/20 rounded-[2rem] lg:rounded-[2.5rem] space-y-6">
                                 <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                       <p className="text-[10px] font-black text-white uppercase tracking-widest">Nivel</p>
                                 ...
                                 <div className="space-y-3">
                                    ...
                                    <div className="w-full h-1.5 bg-white/10 rounded-full overflow-hidden">
                                       <div className="w-[90%] h-full bg-cyan-500 shadow-[0_0_10px_rgba(34,211,238,0.5)]" />
                                    </div>
                                 </div>
                                 <ul className="space-y-3 pt-4 border-t border-white/5">
                                    <li className="flex items-center gap-3 text-[10px] font-bold text-gray-400">
                              ...
                              <div className="p-4 lg:p-6 bg-white/5 rounded-3xl border border-white/5 flex items-center justify-between">
                                 <div>
                                    <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-1">Feedback</p>
                                    <p className="text-xs lg:text-sm font-black text-white">24 Comentarios</p>
                                 </div>
                       ...
                       <div className="space-y-8">
                          <div className="flex flex-col md:flex-row gap-4 md:items-center justify-between">
                             <div className="relative flex-1 max-w-md">
                                <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 lg:w-5 lg:h-5 text-gray-500" />
                                <input 
                                  placeholder="BUSCAR APP..." 
                                  className="w-full bg-white/5 border border-white/10 p-3 lg:p-4 pl-12 rounded-2xl focus:border-cyan-500 outline-none uppercase font-black text-[10px] lg:text-xs tracking-widest"
                                />
                             </div>
                             <div className="flex gap-2">
                                <button className="flex-1 lg:flex-none px-4 lg:px-6 py-3 lg:py-4 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center gap-2 hover:bg-white/10 transition-all">
                                   <Filter className="w-4 h-4 lg:w-5 lg:h-5" />
                                   <span className="text-[10px] font-black uppercase">Filtrar</span>
                                </button>
                                <button onClick={() => setActiveTab('publish')} className="flex-[2] lg:flex-none px-6 lg:px-8 py-3 lg:py-4 bg-white text-black rounded-2xl font-black uppercase text-[10px] flex items-center justify-center gap-3 hover:bg-cyan-500 transition-all whitespace-nowrap">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-20">
                            {apps.map(app => (
                              <div key={app.id} className="p-6 lg:p-8 bg-white/[0.02] border border-white/10 rounded-[2rem] lg:rounded-[2.5rem] group hover:border-white/20 transition-all relative overflow-hidden">
                                 ...
                                 <div className="flex items-start justify-between relative z-10">
                                    ...
                                    <div className="flex gap-2">
                                       <button className="p-2 lg:p-3 bg-white/5 hover:bg-cyan-500 hover:text-black rounded-xl transition-all">
                                          <Edit className="w-4 h-4 lg:w-5 lg:h-5" />
                                       </button>
                                       <button className="p-2 lg:p-3 bg-white/5 hover:bg-red-500 text-white rounded-xl transition-all">
                                 ...
                                 <div className="mt-6 lg:mt-8 space-y-4 relative z-10">
                                    <div>
                                       <h3 className="text-xl lg:text-2xl font-black text-white uppercase tracking-tighter truncate">{app.app_name}</h3>
                                       <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest mt-1">v{app.version} • {app.category}</p>
                                    </div>
                                    
                                    <div className="grid grid-cols-3 gap-2 lg:gap-4 py-4 lg:py-6 border-y border-white/5">
                                       <div>
                                          <p className="text-[8px] lg:text-[10px] font-black text-gray-500 uppercase mb-1">Downloads</p>
                                          <p className="text-base lg:text-lg font-black text-white">{app.downloads}</p>
                                       </div>
                                       <div>
                                          <p className="text-[8px] lg:text-[10px] font-black text-gray-500 uppercase mb-1">Rating</p>
                                          <div className="flex items-center gap-1">
                                             <Star className="w-3 h-3 lg:w-4 lg:h-4 text-yellow-500 fill-current" />
                                             <p className="text-base lg:text-lg font-black text-white">{app.rating}</p>
                                          </div>
                                       </div>
                                       <div>
                                          <p className="text-[8px] lg:text-[10px] font-black text-gray-500 uppercase mb-1">Status</p>
                                    ...
                                    <button className="w-full py-4 bg-white/5 hover:bg-white text-gray-400 hover:text-black rounded-2xl font-black uppercase text-[9px] lg:text-[10px] tracking-[0.2em] transition-all flex items-center justify-center gap-2">
                            ...
                            {apps.length === 0 && (
                              <div className="col-span-full py-12 lg:py-24 text-center">
                                 ...
                                 <p className="text-xs text-gray-500 max-w-sm mx-auto mt-2 px-4">No has publicado ninguna aplicación todavía. Comienza subiendo tu primer APK.</p>
                              </div>
                            )}
                          </div>
                       </div>
                    ...
                    {(activeTab === 'analytics' || activeTab === 'settings') && (
                       <div className="py-12 lg:py-24 flex flex-col items-center justify-center text-center space-y-4 px-4">
                          ...
                          <p className="text-xs lg:text-sm text-gray-500 max-w-md">Estamos integrando el nuevo sistema de analíticas en tiempo real. Esta sección estará disponible en la próxima actualización.</p>
                       </div>
                    )}
                  </motion.div>
                </AnimatePresence>
